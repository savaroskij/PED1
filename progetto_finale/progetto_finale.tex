...
Il fenomeno della diffusione di una goccia d'inchiostro in un bicchiere
...
ordinato ad uno disordinato costituiscono buoni esempi.
...
a casa mediante il software \emph{GeoGebra}
\footnote{
...
utilizzando GeoGebra. L’insegnante invia agli studenti il file progetto contenente
la curva mostrata in classe; In questo modo tutti gli studenti possono
...
B rispetto al punto A, che rimane fisso. L’insegnante quindi tramite lo slider sposta il
...
\footnote{
          ...
          essere avvicinati fino a non poterne più apprezzare la
          distanza.
         }
...
\begin{itemize}
\item \textbf{Tempo richiesto in aula:} 30\textsuperscript{$\prime$}
      di discussione tra studenti + 20\textsuperscript{$\prime$} di dialogo con il
      docente.
...
Durante la lezione successiva l'insegnante chiede agli studenti
...
l'accelerazione passa a un valore non nullo partendo da un valore nullo
all'istante precedente. Questo valore si
mantiene costante (a meno di oscillazioni) per tutta la durata
