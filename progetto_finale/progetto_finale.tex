...
\begin{itemize}
\item \textbf{Tempo richiesto in aula:} 15\textsuperscript{$\prime$}
\item \textbf{Materiale:} Liquidi di Differente Viscosità, Contenitori Trasparenti Identici, Biglia
\end{itemize}
...
della biglia all'interno del contenitore sarà visibilmete differente.

In questo progetto sono stati scelti le seguenti sostanze: detersivo per i piatti,
...
Le biglie utilizzate devono essere tutte uguali tra loro.
...
\centering
  ...
  \caption{
           ...
           velocità: detersivo, acua, olio di semi.
          }
  \label{fig:liquids}
\end{figure}
...
esperienza dei significati ai quali questi termini riferiscono,
prima che i termini vengano introdotti. Questo vale in particolare
...
Se l'esperienza viene mostrata in modalità in presenza, il professore
può chiedere a tre studenti di lasciar cadere la biglia nei tre recipienti
nello stesso momento; in questo modo gli alunni saranno facilitati
nell'osservare quale pallina giunge prima e quale dopo sul fondo del
recipiente. Nel caso della DAD, utilizzerà liquidi diversi in sequenza,
ma dovrà avere partcicolare cura di scegliere tre sostanze dalla
